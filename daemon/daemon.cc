...
auto constexpr Options = std::array<tr_option, 45>{
    { { 'a', "allowed", "Allowed IP addresses. (Default: " TR_DEFAULT_RPC_WHITELIST ")", "a", true, "<list>" },
      ...
      { 'T', "no-auth", "Don't require authentication", "T", true, nullptr },
      { 'u', "username", "Set username for authentication", "u", false, "<username>" },
      { 'v', "password", "Set password for authentication", "v", false, "<password>" },
